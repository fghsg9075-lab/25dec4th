...
export interface User {
  ...
  // Content Unlocking
  purchasedContent?: string[]; // List of Content IDs (ChapterID + Type) unlocked via credits
}
...
export type StudentTab = 'ROUTINE' | 'VIDEOS' | 'PDF_FREE' | 'PDF_PREMIUM' | 'PDF_ULTRA' | 'MCQ' | 'CHAT' | 'HISTORY' | 'REDEEM' | 'PREMIUM' | 'GAME' | 'WEEKLY_TEST' | 'PROFILE';
