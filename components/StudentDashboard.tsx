...
import { McqLibrary } from './McqLibrary';
...
export const StudentDashboard: React.FC<Props> = ({ user, dailyStudySeconds, onSubjectSelect, onRedeemSuccess, settings, onStartWeeklyTest }) => {
  ...
  return (
    <div>
        ...
        <div className="bg-white p-2 rounded-xl border border-slate-200 shadow-sm mb-8 sticky top-20 z-20 overflow-x-auto flex gap-1 no-scrollbar">
            <button onClick={() => setActiveTab('ROUTINE')} className={`flex-shrink-0 flex flex-col items-center justify-center p-2 rounded-lg transition-all w-[60px] ${activeTab === 'ROUTINE' ? 'bg-slate-100 text-[var(--primary)]' : 'text-slate-400 hover:bg-slate-50'}`}><Calendar size={18} className="mb-1" /><span className="text-[9px] font-bold uppercase">Routine</span></button>
            <button onClick={() => setActiveTab('VIDEOS')} className={`flex-shrink-0 flex flex-col items-center justify-center p-2 rounded-lg transition-all w-[60px] ${activeTab === 'VIDEOS' ? 'bg-red-50 text-red-600' : 'text-slate-400 hover:bg-slate-50'}`}><Play size={18} className="mb-1" /><span className="text-[9px] font-bold uppercase">Videos</span></button>
            
            <button onClick={() => setActiveTab('PDF_FREE')} className={`flex-shrink-0 flex flex-col items-center justify-center p-2 rounded-lg transition-all w-[60px] ${activeTab === 'PDF_FREE' ? 'bg-blue-50 text-blue-600' : 'text-slate-400 hover:bg-slate-50'}`}><BookOpen size={18} className="mb-1" /><span className="text-[9px] font-bold uppercase">Notes</span></button>
            <button onClick={() => setActiveTab('PDF_PREMIUM')} className={`flex-shrink-0 flex flex-col items-center justify-center p-2 rounded-lg transition-all w-[60px] ${activeTab === 'PDF_PREMIUM' ? 'bg-purple-50 text-purple-600' : 'text-slate-400 hover:bg-slate-50'}`}><Sparkles size={18} className="mb-1" /><span className="text-[9px] font-bold uppercase">Prem</span></button>
            <button onClick={() => setActiveTab('PDF_ULTRA')} className={`flex-shrink-0 flex flex-col items-center justify-center p-2 rounded-lg transition-all w-[60px] ${activeTab === 'PDF_ULTRA' ? 'bg-amber-50 text-amber-600' : 'text-slate-400 hover:bg-slate-50'}`}><Crown size={18} className="mb-1" /><span className="text-[9px] font-bold uppercase">Ultra</span></button>
            <button onClick={() => setActiveTab('MCQ')} className={`flex-shrink-0 flex flex-col items-center justify-center p-2 rounded-lg transition-all w-[60px] ${activeTab === 'MCQ' ? 'bg-emerald-50 text-emerald-600' : 'text-slate-400 hover:bg-slate-50'}`}><CheckCircle size={18} className="mb-1" /><span className="text-[9px] font-bold uppercase">MCQ</span></button>

            <button onClick={() => setActiveTab('CHAT')} className={`flex-shrink-0 flex flex-col items-center justify-center p-2 rounded-lg transition-all w-[60px] ${activeTab === 'CHAT' ? 'bg-slate-100 text-[var(--primary)]' : 'text-slate-400 hover:bg-slate-50'}`}><MessageCircle size={18} className="mb-1" /><span className="text-[9px] font-bold uppercase">Chat</span></button>
            <button onClick={() => setActiveTab('LEADERBOARD')} className={`flex-shrink-0 flex flex-col items-center justify-center p-2 rounded-lg transition-all w-[60px] ${activeTab === 'LEADERBOARD' ? 'bg-slate-100 text-[var(--primary)]' : 'text-slate-400 hover:bg-slate-50'}`}><Trophy size={18} className="mb-1" /><span className="text-[9px] font-bold uppercase">Rank</span></button>
            {isGameEnabled && <button onClick={() => setActiveTab('GAME')} className={`flex-shrink-0 flex flex-col items-center justify-center p-2 rounded-lg transition-all w-[60px] ${activeTab === 'GAME' ? 'bg-orange-50 text-orange-600' : 'text-slate-400 hover:bg-slate-50'}`}><Gamepad2 size={18} className="mb-1" /><span className="text-[9px] font-bold uppercase">Game</span></button>}
            <button onClick={() => setActiveTab('HISTORY')} className={`flex-shrink-0 flex flex-col items-center justify-center p-2 rounded-lg transition-all w-[60px] ${activeTab === 'HISTORY' ? 'bg-slate-100 text-[var(--primary)]' : 'text-slate-400 hover:bg-slate-50'}`}><History size={18} className="mb-1" /><span className="text-[9px] font-bold uppercase">History</span></button>
            <button onClick={() => setActiveTab('REDEEM')} className={`flex-shrink-0 flex flex-col items-center justify-center p-2 rounded-lg transition-all w-[60px] ${activeTab === 'REDEEM' ? 'bg-slate-100 text-[var(--primary)]' : 'text-slate-400 hover:bg-slate-50'}`}><Gift size={18} className="mb-1" /><span className="text-[9px] font-bold uppercase">Redeem</span></button>
            <button onClick={() => setActiveTab('STORE')} className={`flex-shrink-0 flex flex-col items-center justify-center p-2 rounded-lg transition-all w-[60px] ${activeTab === 'STORE' ? 'bg-gradient-to-br from-green-400 to-blue-500 text-white shadow-md' : 'text-slate-400 hover:bg-slate-50'}`}><ShoppingBag size={18} className="mb-1" /><span className="text-[9px] font-bold uppercase">Store</span></button>
            {settings?.weeklyTests?.some(t => t.isActive && t.classLevel === user.classLevel) && <button onClick={() => setActiveTab('WEEKLY_TEST')} className={`flex-shrink-0 flex flex-col items-center justify-center p-2 rounded-lg transition-all w-[60px] ${activeTab === 'WEEKLY_TEST' ? 'bg-gradient-to-br from-red-400 to-pink-500 text-white shadow-md' : 'text-slate-400 hover:bg-slate-50'}`}><Calendar size={18} className="mb-1" /><span className="text-[9px] font-bold uppercase">Test</span></button>}
            <button onClick={() => setActiveTab('PROFILE')} className={`flex-shrink-0 flex flex-col items-center justify-center p-2 rounded-lg transition-all w-[60px] ${activeTab === 'PROFILE' ? 'bg-gradient-to-br from-purple-400 to-indigo-500 text-white shadow-md' : 'text-slate-400 hover:bg-slate-50'}`}><Settings size={18} className="mb-1" /><span className="text-[9px] font-bold uppercase">Profile</span></button>
            <button onClick={() => setActiveTab('PREMIUM')} className={`flex-shrink-0 flex flex-col items-center justify-center p-2 rounded-lg transition-all w-[60px] ${activeTab === 'PREMIUM' ? 'bg-gradient-to-br from-yellow-400 to-orange-500 text-white shadow-md' : 'text-slate-400 hover:bg-slate-50'}`}><Sparkles size={18} className="mb-1" /><span className="text-[9px] font-bold uppercase">Premium</span></button>
        </div>

        <div className="min-h-[400px]">
          <ErrorBoundary>
            {activeTab === 'ROUTINE' && <RoutineView />}
            {activeTab === 'VIDEOS' && <VideoLibrary user={user} onUnlock={(cost, id) => {
                const updated = { ...user, credits: (user.credits || 0) - cost, purchasedContent: [...(user.purchasedContent || []), id] };
                handleUserUpdate(updated);
            }} />}
            {activeTab === 'PDF_FREE' && <PdfLibrary user={user} mode="FREE" onUnlock={(cost, id) => {
                const updated = { ...user, credits: (user.credits || 0) - cost, purchasedContent: [...(user.purchasedContent || []), id] };
                handleUserUpdate(updated);
            }} />}
            {activeTab === 'PDF_PREMIUM' && <PdfLibrary user={user} mode="PREMIUM" onUnlock={(cost, id) => {
                const updated = { ...user, credits: (user.credits || 0) - cost, purchasedContent: [...(user.purchasedContent || []), id] };
                handleUserUpdate(updated);
            }} />}
            {activeTab === 'PDF_ULTRA' && <PdfLibrary user={user} mode="ULTRA" onUnlock={(cost, id) => {
                const updated = { ...user, credits: (user.credits || 0) - cost, purchasedContent: [...(user.purchasedContent || []), id] };
                handleUserUpdate(updated);
            }} />}
            {activeTab === 'MCQ' && <McqLibrary user={user} onUnlock={(cost, id) => {
                const updated = { ...user, credits: (user.credits || 0) - cost, purchasedContent: [...(user.purchasedContent || []), id] };
                handleUserUpdate(updated);
            }} />}
